...
figma.ui.onmessage = async (msg) => {
    ...
    if (msg.type === 'get-variables') {
        try {
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to fetch variables: ' + (error as Error).message });
        }
        ...
        try {
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to create variable: ' + (error as Error).message });
        }
        ...
        try {
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to update variable: ' + (error as Error).message });
        }
        ...
        try {
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to create mode: ' + (error as Error).message });
        }
        ...
        try {
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to rename mode: ' + (error as Error).message });
        }
        ...
        try {
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to delete mode: ' + (error as Error).message });
        }
        ...
        try {
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to duplicate variable: ' + (error as Error).message });
        }
        ...
        try {
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to delete variable: ' + (error as Error).message });
        }
    } else if (msg.type === 'paste-variable') {
        console.log('Attempting to paste variable:', msg);
        try {
            const { variable, collectionId } = msg as { variable: VariableToPaste; collectionId: string };
            ...
            const newVariable = figma.variables.createVariable(
                variable.name + (variable.action === 'cut' ? '' : ' (Copy)'),
                collectionId,
            ...
            figma.ui.postMessage({ type: 'error', message: 'Failed to paste variable: ' + (error as Error).message });
        }
    }
};